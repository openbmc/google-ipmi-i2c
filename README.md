...
extended to expose the needed I2C adapters for use by Gsys.
...
Class device attributes at /sys/class/i2c-via-ipmi/${name}

*   name - identifies proxy
*   bus - selects i2c adapter at BMC
*   device - symlink host tool can use for i2c requests

##### Non-class alternatives

Device tree nodes

*   compatible = "i2c-via-ipmi-proxy"
*   bmc-bus = n, for i2c-n proxy
*   Not available on many servers, e.g., most x86

ACPI - Possible enhancement, similar to device tree

Module parameters - Possible enhancement, similar to i2c-stub
