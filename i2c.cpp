...
static ipmi::Cc parseReqHdr(std::span<const uint8_t> data, size_t* bytesUsed,
                            i2c::ParsedReq* req)
{
...
static ipmi::Cc parseReqStep(std::span<const uint8_t> data, size_t* bytesUsed,
                             i2c::ParsedReq* req)
{
...
// Parse i2c request.
static ipmi::Cc parse(std::span<const uint8_t> data, i2c::ParsedReq* req)
{
    size_t bytesUsed = 0;
